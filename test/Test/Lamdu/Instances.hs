...
deriving instance (Eq a, Eq n) => Eq (Sugar.Case n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n) => Eq (Sugar.CaseArg n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n) => Eq (Sugar.CaseKind n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n) => Eq (Sugar.Composite n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n) => Eq (Sugar.CompositeFields n a)
deriving instance (Eq a, Eq n) => Eq (Sugar.CompositeItem n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n) => Eq (Sugar.CompositeTail n Unit Unit # Annotated a)
...
deriving instance (Eq a, Eq n) => Eq (Sugar.Else n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n) => Eq (Sugar.ElseIfContent n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n) => Eq (Sugar.Fragment n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n) => Eq (Sugar.Function n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n) => Eq (Sugar.GetField n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n) => Eq (Sugar.IfElse n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n) => Eq (Sugar.Inject n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n) => Eq (Sugar.InjectContent n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n) => Eq (Sugar.LabeledApply n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n) => Eq (Sugar.Lambda n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n) => Eq (Sugar.Let n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n) => Eq (Sugar.Nominal n Unit Unit # Annotated a)
...
deriving instance (Eq a, Eq n) => Eq (Sugar.Term n Unit Unit # Annotated a)
...
deriving instance Eq n => Eq (Sugar.FuncParam n Unit)
...
instance (NFData a, NFData n) => NFData (Sugar.Case n (T i) (T o) # Annotated a)
instance (NFData a, NFData n) => NFData (Sugar.CaseArg n (T i) (T o) # Annotated a)
instance (NFData a, NFData n) => NFData (Sugar.CaseKind n (T i) (T o) # Annotated a)
instance (NFData a, NFData n) => NFData (Sugar.Composite n (T i) (T o) # Annotated a)
instance (NFData a, NFData n) => NFData (Sugar.CompositeFields n a)
instance (NFData a, NFData n) => NFData (Sugar.CompositeItem n (T i) (T o) # Annotated a)
instance (NFData a, NFData n) => NFData (Sugar.CompositeTail n (T i) (T o) # Annotated a)
...
instance (NFData a, NFData n) => NFData (Sugar.Else n (T i) (T o) # Annotated a)
instance (NFData a, NFData n) => NFData (Sugar.ElseIfContent n (T i) (T o) # Annotated a)
instance (NFData a, NFData n) => NFData (Sugar.Fragment n (T i) (T o) # Annotated a)
instance (NFData a, NFData n) => NFData (Sugar.Function n (T i) (T o) # Annotated a)
instance (NFData a, NFData n) => NFData (Sugar.GetField n (T i) (T o) # Annotated a)
instance (NFData a, NFData n) => NFData (Sugar.IfElse n (T i) (T o) # Annotated a)
instance (NFData a, NFData n) => NFData (Sugar.Inject n (T i) (T o) # Annotated a)
instance (NFData a, NFData n) => NFData (Sugar.InjectContent n (T i) (T o) # Annotated a)
instance (NFData a, NFData n) => NFData (Sugar.LabeledApply n (T i) (T o) # Annotated a)
instance (NFData a, NFData n) => NFData (Sugar.Lambda n (T i) (T o) # Annotated a)
instance (NFData a, NFData n) => NFData (Sugar.Let n (T i) (T o) # Annotated a)
instance (NFData a, NFData n) => NFData (Sugar.Nominal n (T i) (T o) # Annotated a)
...
instance (NFData a, NFData n) => NFData (Sugar.Term n (T i) (T o) # Annotated a)
...
instance NFData n => NFData (Sugar.FuncParam n (T i))
