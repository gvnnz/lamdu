...
deriving instance (Eq a, Eq n, Eq v) => Eq (Sugar.Payload v n Unit Unit a)
...
instance (NFData a, NFData n, NFData v) => NFData (Sugar.Definition v n (T i) (T o) a)
instance (NFData a, NFData n, NFData v) => NFData (Sugar.DefinitionBody v n (T i) (T o) a)
instance (NFData a, NFData n, NFData v) => NFData (Sugar.DefinitionExpression v n (T i) (T o) a)
...
instance (NFData a, NFData n, NFData v) => NFData (Sugar.Pane v n (T i) (T o) a)
instance (NFData a, NFData n, NFData v) => NFData (Sugar.PaneBody v n (T i) (T o) a)
instance (NFData a, NFData n, NFData v) => NFData (Sugar.Payload v n (T i) (T o) a)
instance (NFData a, NFData n, NFData v) => NFData (Sugar.Repl v n (T i) (T o) a)
instance (NFData a, NFData n, NFData v) => NFData (Sugar.Term v n (T i) (T o) # Annotated a)
instance (NFData a, NFData n, NFData v) => NFData (Sugar.WorkArea v n (T i) (T o) a)
