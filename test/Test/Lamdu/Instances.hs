...
deriving instance (Eq a, Eq n, Eq v) => Eq (Sugar.ElseIfContent v n Unit Unit # Annotated a)
...
instance (NFData a, NFData n, NFData v) => NFData (Sugar.ElseIfContent v n (T i) (T o) # Annotated a)
