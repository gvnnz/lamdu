...
deriving instance (Eq a, Eq n) => Eq (Sugar.AssignPlain n Unit Unit # Ann (Const a))
deriving instance (Eq a, Eq n) => Eq (Sugar.Assignment n Unit Unit # Ann (Const a))
deriving instance (Eq a, Eq n) => Eq (Sugar.Binder n Unit Unit # Ann (Const a))
deriving instance (Eq a, Eq n) => Eq (Sugar.Body n Unit Unit # Ann (Const a))
deriving instance (Eq a, Eq n) => Eq (Sugar.Case n Unit Unit # Ann (Const a))
deriving instance (Eq a, Eq n) => Eq (Sugar.Composite n Unit Unit # Ann (Const a))
...
deriving instance (Eq a, Eq n) => Eq (Sugar.Else n Unit Unit # Ann (Const a))
deriving instance (Eq a, Eq n) => Eq (Sugar.ElseIfContent n Unit Unit # Ann (Const a))
deriving instance (Eq a, Eq n) => Eq (Sugar.Fragment n Unit Unit # Ann (Const a))
deriving instance (Eq a, Eq n) => Eq (Sugar.Function n Unit Unit # Ann (Const a))
deriving instance (Eq a, Eq n) => Eq (Sugar.GetField n Unit Unit a)
deriving instance (Eq a, Eq n) => Eq (Sugar.IfElse n Unit Unit # Ann (Const a))
deriving instance (Eq a, Eq n) => Eq (Sugar.Inject n Unit Unit # Ann (Const a))
deriving instance (Eq a, Eq n) => Eq (Sugar.InjectContent n Unit Unit # Ann (Const a))
deriving instance (Eq a, Eq n) => Eq (Sugar.LabeledApply n Unit Unit # Ann (Const a))
deriving instance (Eq a, Eq n) => Eq (Sugar.Lambda n Unit Unit # Ann (Const a))
deriving instance (Eq a, Eq n) => Eq (Sugar.Let n Unit Unit # Ann (Const a))
...
deriving instance (Eq a, Eq n) => Eq (Sugar.Type n # Ann (Const a))
...
deriving instance Eq n => Eq (Sugar.HoleOption n Unit Unit)
...
instance (NFData a, NFData n) => NFData (Sugar.AssignPlain n (T i) (T o) # Ann (Const a))
instance (NFData a, NFData n) => NFData (Sugar.Assignment n (T i) (T o) # Ann (Const a))
instance (NFData a, NFData n) => NFData (Sugar.Binder n (T i) (T o) # Ann (Const a))
instance (NFData a, NFData n) => NFData (Sugar.Body n (T i) (T o) # Ann (Const a))
instance (NFData a, NFData n) => NFData (Sugar.Case n (T i) (T o) # Ann (Const a))
instance (NFData a, NFData n) => NFData (Sugar.Composite n (T i) (T o) # Ann (Const a))
...
instance (NFData a, NFData n) => NFData (Sugar.Else n (T i) (T o) # Ann (Const a))
instance (NFData a, NFData n) => NFData (Sugar.ElseIfContent n (T i) (T o) # Ann (Const a))
instance (NFData a, NFData n) => NFData (Sugar.Fragment n (T i) (T o) # Ann (Const a))
instance (NFData a, NFData n) => NFData (Sugar.Function n (T i) (T o) # Ann (Const a))
instance (NFData a, NFData n) => NFData (Sugar.GetField n (T i) (T o) a)
instance (NFData a, NFData n) => NFData (Sugar.IfElse n (T i) (T o) # Ann (Const a))
instance (NFData a, NFData n) => NFData (Sugar.Inject n (T i) (T o) # Ann (Const a))
instance (NFData a, NFData n) => NFData (Sugar.InjectContent n (T i) (T o) # Ann (Const a))
instance (NFData a, NFData n) => NFData (Sugar.LabeledApply n (T i) (T o) # Ann (Const a))
instance (NFData a, NFData n) => NFData (Sugar.Lambda n (T i) (T o) # Ann (Const a))
instance (NFData a, NFData n) => NFData (Sugar.Let n (T i) (T o) # Ann (Const a))
...
instance (NFData a, NFData n) => NFData (Sugar.Type n # Ann (Const a))
